...
resource "aws_subnet" "PcfVpcOdServicesSubnet_az1" {
    vpc_id = "${aws_vpc.PcfVpc.id}"

    cidr_block = "${var.od_services_subnet_cidr_az1}"
    availability_zone = "${var.az1}"
...
resource "aws_subnet" "PcfVpcOdServicesSubnet_az2" {
    vpc_id = "${aws_vpc.PcfVpc.id}"

    cidr_block = "${var.od_services_subnet_cidr_az2}"
    availability_zone = "${var.az2}"
...
resource "aws_subnet" "PcfVpcOdServicesSubnet_az3" {
    vpc_id = "${aws_vpc.PcfVpc.id}"

    cidr_block = "${var.od_services_subnet_cidr_az3}"
    availability_zone = "${var.az3}"
